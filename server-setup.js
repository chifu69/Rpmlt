...
POST /migration/import</pre></details>`}
 ...
 $('#cfgSave').onclick=()=>{const c=window.saveRpiaConfig(values());window.RPIA_DATA.configure(c);$('#cfgResult').className='connection-result ok';$('#cfgResult').textContent='Configuration saved. Reload RP to apply it everywhere.'};
